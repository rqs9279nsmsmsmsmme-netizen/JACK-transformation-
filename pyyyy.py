...
WDEH = render('WEB', colors=['blue', 'green'], align='center')
live_text(WDEH)
print('')                                                               
print("\033[1;94m" + "" * 82)
...
reset=_X
try:
    ID = int(input(f"{green}Enter ID:{cyan} "))
except ValueError:
...
\033[92m Hits : {hits}\033[0m
\033[94m good gmail : {badinsta}\033[0m
\033[91m False : {bademail}\033[0m
\033[93m BAD : {goodig}\033[0m
""";sys.stdout.write(output);sys.stdout.flush()
a=print(f"""
{cyan}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{cyan}{blue}-> {white} Welcome to WEB Tool {blue}<-
{cyan}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
{cyan}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
""")
Vortex=input(f"{green}-> {white}choice: {reset}")
...
"""
	...
	with open('WEB.txt','a')as ff:ff.write(f"{ss}\n")
	try:
